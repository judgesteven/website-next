...
const stats = [
  ...
  { title: 'Leaderboards', value: '89', subtitle: 'Active competitions', change: '+7%', icon: Star, color: 'text-indigo-600' },
  { title: 'Mystery Wins', value: '127', subtitle: 'Surprise rewards', change: '+31%', icon: Gift, color: 'text-red-600' },
  { title: 'Prize Redemptions', value: '89', subtitle: 'This month', change: '+14%', icon: Ticket, color: 'text-amber-600' }
]
